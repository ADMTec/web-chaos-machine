...
class sqlServerStatement
{
    ...
    {
        $this->resource = mssql_query( $this->query, $this->objCon );
...
class pdoLib
{
    ...
    {
        $this->objCon = mssql_connect($this->databaseSettings["address"], $this->databaseSettings["username"], $this->databaseSettings["password"]);
        if($this->objCon == false)
        {
            throw new SqlException("Connection error.\nSQL Message: ". mssql_get_last_message());
        } 
        if(mssql_select_db($this->databaseSettings["database"]["account"], $this->objCon) == false)
        {
